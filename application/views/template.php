...
<html>
    <head>
        ...
        <script src="<?php echo base_url()?>assets/js/jquery.bootstrap-touchspin.min.js" type="text/javascript"></script>
        <!-- BOOTSTRAP -->
        ...
        <link href="<?php echo base_url()?>assets/css/jquery.bootstrap-touchspin.min.css" rel="stylesheet" type="text/css"/>
                ...
                <div id="navContainer" class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="header-nav">
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            {/menu_items_profile}
                            {menu_items_logout}
                            <li class="navLogout"><a href="{link}" title="{title}"><span class="glyphicon glyphicon-log-out" aria-hidden="true"></span></a></li>
                            {/menu_items_logout}
                        </ul>
                    </div>
                </div>
